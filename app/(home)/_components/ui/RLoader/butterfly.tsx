          ...
          <div className="shape butterfly">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              ...
              >
                ...
                <circle cx="40" cy="140" r="6" fill="#ddd6fe" opacity="0.7" />
                <circle cx="75" cy="100" r="5" fill="#ede9fe" opacity="0.7" />
                <path
              ...
              >
                ...
                <circle cx="160" cy="140" r="6" fill="#ddd6fe" opacity="0.7" />
                <circle cx="125" cy="100" r="5" fill="#ede9fe" opacity="0.7" />
                <path
              ...
              >
                ...
                <circle cx="160" cy="70" r="4" fill="#c4b5fd" opacity="0.7" />
                <circle cx="130" cy="45" r="3" fill="#ddd6fe" opacity="0.7" />
                <path
              ...
              <g className="butterfly__body">
                ...
                <path d="M103,65 L107,50" stroke="#9333ea" strokeWidth="1.5" />
