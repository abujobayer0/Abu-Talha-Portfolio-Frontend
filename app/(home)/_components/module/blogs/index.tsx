...
export const CommonBlogCard = ({ blog, isEditable, index = 0 }: BlogCardProps) => {
  return (
    <motion.div
      initial='hidden'
      whileInView='visible'
      ...
      <div className='group relative bg-white/30 dark:bg-gray-800/30 backdrop-blur-md rounded-2xl overflow-hidden border border-purple-100 dark:border-purple-900 shadow-lg hover:shadow-purple-300/30 hover:ring-2 hover:ring-purple-400/50 transition-all duration-300'>
        ...
        <div className='p-5'>
          ...
          <div className='mt-4 relative z-10'>
            <h4 className='font-bold text-purple-800 dark:text-purple-200 text-lg line-clamp-2'>{blog?.title || 'Title'}</h4>
            <div
              className='text-sm text-gray-700 dark:text-purple-300 mt-2 line-clamp-2'
              dangerouslySetInnerHTML={{ __html: blog.content }}
            />
            <span className='pointer-events-none select-none flex items-center text-purple-800 dark:text-purple-200 font-medium text-sm mt-4'>
              Read more
