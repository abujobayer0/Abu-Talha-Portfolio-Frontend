          ...
          {projects?.map((project, index) => (
            ...
            >
              <Link href={`/projects/${project._id}`} className='block'>
                <div className='group relative bg-white/30 dark:bg-gray-800/30 backdrop-blur-md rounded-2xl overflow-hidden border border-purple-100 dark:border-purple-900 shadow-lg hover:shadow-purple-300/30 hover:ring-2 hover:ring-purple-400/50 transition-all duration-300 cursor-pointer'>
                  ...
                  <div className='p-5 z-10 relative'>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                      <div className='flex gap-3'>
                        {project.live && (
                          <Link
                            className='flex items-center justify-center size-9 rounded-full bg-gradient-to-br from-purple-200 to-purple-400/40 shadow-inner shadow-purple-500/20 text-purple-800 dark:text-purple-200 hover:bg-purple-400/60 transition z-20 relative'
                            href={project.live}
                            target='_blank'
                      ...
                      <div className='flex items-center text-purple-800 dark:text-purple-200 font-medium hover:text-purple-600 dark:hover:text-white text-sm transition'>
                        View Case Study
