              ...
              <div className="mb-6">
                <ul className="flex justify-between items-center">
                  <li className={`step-item ${formStep >= 0 ? 'active' : ''}`}>
                    <div
                      className={`step-circle ${formStep >= 0 ? 'bg-warning text-gray-900' : 'bg-gray-700 text-gray-400'}`}
                    >
                      1
                    </div>
                    <div
                      className={`step-text ${formStep >= 0 ? 'text-white' : 'text-gray-500'}`}
                    >
                      Contact Info
                    </div>
                  </li>
                  ...
                  <li className={`step-item ${formStep >= 1 ? 'active' : ''}`}>
                    <div
                      className={`step-circle ${formStep >= 1 ? 'bg-warning text-gray-900' : 'bg-gray-700 text-gray-400'}`}
                    >
                      2
                    </div>
                    <div
                      className={`step-text ${formStep >= 1 ? 'text-white' : 'text-gray-500'}`}
                    >
                      Message
                    </div>
                  </li>
                ...
                >
                  <Input
                    ...
                    classNames={{
                      ...
                      inputWrapper:
                        'bg-white/5 backdrop-blur-md border-gray-600',
                    }}
