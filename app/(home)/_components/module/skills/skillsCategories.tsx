...
const SkillCategories: FC = () => {
  ...
  const filteredSkills =
    searchTerm && skillsByCategory[selectedCategory]
      ? skillsByCategory[selectedCategory].filter((skill) =>
          ...
          {searchTerm ? (
            <>
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md">
                No skills match your search "{searchTerm}" in the{' '}
                {selectedCategory} category.
              </p>
              <button
            ...
            <>
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md">
                No skills are currently available in the {selectedCategory}{' '}
                category.
              </p>
            </>
          )}
      ...
      {!isLoading && filteredSkills.length > 0 && (
        ...
        >
          <p>
            ...
            {searchTerm ? ` matching "${searchTerm}"` : ''} in{' '}
            {selectedCategory}
          </p>
